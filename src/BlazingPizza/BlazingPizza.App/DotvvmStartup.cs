...
namespace BlazingPizza.App
{
    public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
    {
        ...
        {
            config.RouteTable.Add("GetPizza", "", "Views/GetPizza.dothtml");
            config.RouteTable.Add("Checkout", "checkout", "Views/Checkout.dothtml");
            config.RouteTable.Add("MyOrders", "myorders", "Views/MyOrders.dothtml");
